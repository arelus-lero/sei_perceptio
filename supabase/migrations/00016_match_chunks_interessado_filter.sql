-- Migration: 00015_match_chunks_interessado_filter.sql
-- RF-019: filtro híbrido por interessado (processo.interessados)

DROP FUNCTION IF EXISTS public.match_chunks_hybrid(vector, text, uuid, uuid[], text[], text[], date, date, text, uuid[], integer, integer, integer);
